...
directory.  To create the virtualenv it assumes that there is a `python3.12`
(or `python3` for systems where Python 3.12+ is the default) executable in your path with access to the `venv`
package. If for any reason the automatic creation of the virtualenv fails,
you can create the virtualenv manually.

**Note: This project requires Python 3.12 or later.**
